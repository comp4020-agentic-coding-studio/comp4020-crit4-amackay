// One-off: does the bigger close button clear the centred title, and the copy?
(async () => {
  ...
  function measureTitle() {
    const el = panel.querySelector("h1 button");
